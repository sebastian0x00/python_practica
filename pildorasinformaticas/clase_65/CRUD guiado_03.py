...
def crear():
	...
	datos = miNombre.get(),miPass.get(),miApellido.get(),miDirrecion.get(),textoComentario.get("1.0", END)
...
def actualizar():
	...
	miCursor.execute("UPDATE DATOSUSUARIOS SET NOMBRE_USUARIO = ?,PASSWORD = ?, APELLIDO = ?, DIRRECION = ?, COMENTARIOS = ? " + 
